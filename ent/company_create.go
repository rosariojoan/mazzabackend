...
func (cc *CompanyCreate) check() error {
	...
	if _, ok := cc.mutation.BaseCurrency(); !ok {
		return &ValidationError{Name: "baseCurrency", err: errors.New(`ent: missing required field "Company.baseCurrency"`)}
	}
	...
	if _, ok := cc.mutation.EstablishedAt(); !ok {
		return &ValidationError{Name: "establishedAt", err: errors.New(`ent: missing required field "Company.establishedAt"`)}
	}
	if _, ok := cc.mutation.LastEntryDate(); !ok {
		return &ValidationError{Name: "lastEntryDate", err: errors.New(`ent: missing required field "Company.lastEntryDate"`)}
	}
	...
	if _, ok := cc.mutation.NumberOfEmployees(); !ok {
		return &ValidationError{Name: "numberOfEmployees", err: errors.New(`ent: missing required field "Company.numberOfEmployees"`)}
	}
	...
	if _, ok := cc.mutation.TaxId(); !ok {
		return &ValidationError{Name: "taxId", err: errors.New(`ent: missing required field "Company.taxId"`)}
	}
	if _, ok := cc.mutation.VatRate(); !ok {
		return &ValidationError{Name: "vatRate", err: errors.New(`ent: missing required field "Company.vatRate"`)}
	}
	return nil
}
