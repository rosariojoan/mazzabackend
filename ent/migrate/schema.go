...
var (
	...
	AccountingEntriesColumns = []*schema.Column{
		...
		{Name: "account_type", Type: field.TypeEnum, Enums: []string{"asset", "liability", "equity", "revenue", "expense", "taxExpense", "income", "dividendExpense", "contraAsset", "contraLiability", "contraRevenue", "contraExpense"}},
