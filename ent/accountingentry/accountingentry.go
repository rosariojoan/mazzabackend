...
func AccountTypeValidator(at AccountType) error {
	switch at {
	case AccountTypeAsset, AccountTypeLiability, AccountTypeEquity, AccountTypeRevenue, AccountTypeExpense, AccountTypeTaxExpense, AccountTypeIncome, AccountTypeDividendExpense, AccountTypeContraAsset, AccountTypeContraLiability, AccountTypeContraRevenue, AccountTypeContraExpense:
		return nil
	default:
