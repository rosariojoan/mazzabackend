...
func (rc *ReceivableCreate) check() error {
	if _, ok := rc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "Receivable.createdAt"`)}
	}
	if _, ok := rc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "Receivable.updatedAt"`)}
	}
	if _, ok := rc.mutation.EntryGroup(); !ok {
		return &ValidationError{Name: "entryGroup", err: errors.New(`ent: missing required field "Receivable.entryGroup"`)}
	}
	...
	if _, ok := rc.mutation.Date(); !ok {
		return &ValidationError{Name: "date", err: errors.New(`ent: missing required field "Receivable.date"`)}
	}
	if _, ok := rc.mutation.OutstandingBalance(); !ok {
		return &ValidationError{Name: "outstandingBalance", err: errors.New(`ent: missing required field "Receivable.outstandingBalance"`)}
	}
	if _, ok := rc.mutation.TotalTransaction(); !ok {
		return &ValidationError{Name: "totalTransaction", err: errors.New(`ent: missing required field "Receivable.totalTransaction"`)}
	}
	if _, ok := rc.mutation.DaysDue(); !ok {
		return &ValidationError{Name: "daysDue", err: errors.New(`ent: missing required field "Receivable.daysDue"`)}
	}
	...
	if _, ok := rc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "Receivable.status"`)}
	}
