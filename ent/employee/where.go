...
func HasWorkShifts() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkShiftsWith(preds ...predicate.Workshift) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HasApprovedWorkShifts() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasApprovedWorkShiftsWith(preds ...predicate.Workshift) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
// HasAssignedTasks applies the HasEdge predicate on the "assignedTasks" edge.
...
// HasAssignedTasksWith applies the HasEdge predicate on the "assignedTasks" edge with a given conditions (other predicates).
func HasAssignedTasksWith(preds ...predicate.Worktask) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
