...
type CalendarQuery struct {
	...
	loadTotal  []func(context.Context, []*Calendar) error
...
func (cq *CalendarQuery) Modify(modifiers ...func(s *sql.Selector)) *CalendarSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (cs *CalendarSelect) Modify(modifiers ...func(s *sql.Selector)) *CalendarSelect {
