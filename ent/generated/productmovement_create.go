...
func (pmc *ProductMovementCreate) SetNillablePrice(f *float64) *ProductMovementCreate {
	if f != nil {
		pmc.SetPrice(*f)
	}
	return pmc
...
func (pmc *ProductMovementCreate) defaults() {
	...
	if _, ok := pmc.mutation.Price(); !ok {
		v := productmovement.DefaultPrice
		pmc.mutation.SetPrice(v)
	}
}
...
func (pmc *ProductMovementCreate) check() error {
	if _, ok := pmc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`generated: missing required field "ProductMovement.createdAt"`)}
	}
	if _, ok := pmc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`generated: missing required field "ProductMovement.updatedAt"`)}
	}
	if _, ok := pmc.mutation.EntryGroup(); !ok {
		return &ValidationError{Name: "entryGroup", err: errors.New(`generated: missing required field "ProductMovement.entryGroup"`)}
	}
	...
	if _, ok := pmc.mutation.AverageCost(); !ok {
		return &ValidationError{Name: "averageCost", err: errors.New(`generated: missing required field "ProductMovement.averageCost"`)}
	}
	...
	if _, ok := pmc.mutation.UnitCost(); !ok {
		return &ValidationError{Name: "unitCost", err: errors.New(`generated: missing required field "ProductMovement.unitCost"`)}
	}
	...
	if _, ok := pmc.mutation.Price(); !ok {
		return &ValidationError{Name: "price", err: errors.New(`generated: missing required field "ProductMovement.price"`)}
	}
	...
	if _, ok := pmc.mutation.Quantity(); !ok {
		return &ValidationError{Name: "quantity", err: errors.New(`generated: missing required field "ProductMovement.quantity"`)}
	}
	return nil
}
