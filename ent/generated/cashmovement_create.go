...
func (cmc *CashMovementCreate) check() error {
	if _, ok := cmc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`generated: missing required field "CashMovement.createdAt"`)}
	}
	if _, ok := cmc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`generated: missing required field "CashMovement.updatedAt"`)}
	}
	if _, ok := cmc.mutation.Amount(); !ok {
		return &ValidationError{Name: "amount", err: errors.New(`generated: missing required field "CashMovement.amount"`)}
	}
	if _, ok := cmc.mutation.Date(); !ok {
		return &ValidationError{Name: "date", err: errors.New(`generated: missing required field "CashMovement.date"`)}
	}
	if _, ok := cmc.mutation.EntryGroup(); !ok {
		return &ValidationError{Name: "entryGroup", err: errors.New(`generated: missing required field "CashMovement.entryGroup"`)}
	}
