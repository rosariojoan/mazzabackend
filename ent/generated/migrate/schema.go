...
var (
	...
	AccountingEntriesColumns = []*schema.Column{
		...
		{Name: "account_type", Type: field.TypeEnum, Enums: []string{"asset", "liability", "equity", "revenue", "expense", "taxExpense", "income", "dividendExpense", "contraAsset", "contraLiability", "contraEquity", "contraRevenue", "contraExpense"}},
	...
	CompaniesColumns = []*schema.Column{
		...
		{Name: "last_sales_quotation_number", Type: field.TypeInt32, Nullable: true, Default: 0},
		...
		{Name: "quotation_prefix", Type: field.TypeString, Default: "QUO"},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{CompaniesColumns[27]},
				RefColumns: []*schema.Column{CompaniesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{CompaniesColumns[8], CompaniesColumns[19]},
			},
		},
	}
	...
	EmployeesColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Nullable: true, Enums: []string{"active", "onLeave"}, Default: "active"},
	...
	InventoriesColumns = []*schema.Column{
		...
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "name", Type: field.TypeString},
		{Name: "category", Type: field.TypeEnum, Enums: []string{"rawMaterial", "finishedGood", "merchandise", "supplies", "equipment", "other"}},
	...
	InventoryMovementsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "category", Type: field.TypeEnum, Enums: []string{"inflow", "outflow", "adjustment"}},
		{Name: "quantity", Type: field.TypeFloat64},
	...
	InvoicesColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "is_invoice", Type: field.TypeBool, Default: true},
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"draft", "cancelled", "pending", "paid", "overdue", "defaulted"}, Default: "paid"},
		...
		{Name: "terms", Type: field.TypeString, Nullable: true},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{InvoicesColumns[12], InvoicesColumns[29]},
	...
	TokensColumns = []*schema.Column{
		...
		{Name: "category", Type: field.TypeEnum, Enums: []string{"accountDelete"}},
		{Name: "token", Type: field.TypeString},
